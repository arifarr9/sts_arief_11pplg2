            ...
            <div class="booking-form">
                <form>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="checkin" class="form-label">Tangal peminjaman</label>
                                <input id="checkin" class="form-control" type="date" required>
                            </div>
                        </div>
                    <div class="col-sm-4">
    <div class="form-group">
        <label for="rooms" class="form-label">Nama barang</label>
    ...
    <div class="form-group">
        ...
        <input id="adults" class="form-control" type="text" placeholder="">
                    ...
                    <div class="form-btn text-center">
                        <button class="btn btn-primary">PINJAM KESINI</button>
                    </div>
                </form>
            </div>
        </div>
